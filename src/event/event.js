 ...
 *
 */
function addEventListenerOnce(type, callBack, thisObj, match)
{
	if (thisObj === void 0)
	{
		thisObj = null;
 ...
 *
 */
function addEventListener(type, callBack, thisObj, match)
{
	if (thisObj === void 0)
	{
		thisObj = null;
 ...
 *
 */
function removeEventListener(type, callBack, thisObj, match)
{
	if (thisObj === void 0)
	{
		thisObj = null;
 ...
 *
 */
function dispatchEvent(type, param, match)
{
	if (param === void 0)
	{
		param = null;
